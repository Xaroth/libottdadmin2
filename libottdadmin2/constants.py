...
NETWORK_SERVER_ID_LENGTH        =   33  ###< The maximum length of the network id of the servers, in bytes 
                                        ###  including '\0'
...
NETWORK_CLIENTS_LENGTH          =  200  ###< The maximum length for the list of clients that controls a company, 
